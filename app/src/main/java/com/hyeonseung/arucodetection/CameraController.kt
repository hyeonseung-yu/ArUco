...
class CameraController : Fragment(), View.OnClickListener,
    ...
    private external fun findArUCo(image: Image, surface:Surface): String
    /**
        ...
        val onImageAvailableListener =
            OnImageAvailableListener { imReader: ImageReader ->
                ...
                //try {
                    ...
                    val fmt: Int = imReader.getImageFormat()
                    Log.d(TAG, "bob image fmt:$fmt")

                    //result = JNIUtils.detectLane(image, surface, mFileName, mTakePicture)

                    findArUCo( image, surface)
                ...
                /*} catch (e: IllegalStateException) {
                    Log.e(
                        TAG,
                        "Too many images queued for saving, dropping image for request: "
                    )
                    return
                }*/
                image.close()
    ...
    companion object {
        ...
        @JvmStatic fun newInstance(): CameraController = CameraController()
    }
}
